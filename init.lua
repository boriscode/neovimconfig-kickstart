...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- intelephense = {
        --   root_dir = lspconfig.util.root_pattern('composer.json', '.git'), -- Specify root directory based on these patterns
        --
        --   settings = {
        --     intelephense = {
        --       environment = {
        --         phpVersion = '8.3.11', -- Set your PHP version
        --       },
        --     },
        --   },
        -- },
  ...
  require 'kickstart.plugins.leapnvim',
